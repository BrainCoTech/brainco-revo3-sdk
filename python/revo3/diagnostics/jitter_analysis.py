"""Analyze trajectory JSON from teaching_mode.py and quantify jitter.
...
Usage:
    python python/revo3/diagnostics/jitter_analysis.py trajectory.json
    python python/revo3/diagnostics/jitter_analysis.py trajectory.json --plot
    python python/revo3/diagnostics/jitter_analysis.py baseline.json optimized.json
"""

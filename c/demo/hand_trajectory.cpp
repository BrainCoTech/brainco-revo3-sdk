...
int main(int argc, char **argv) {
  ...
  revo3_move_finger_with_joint_gains(ctx.handle, ctx.slave_id, 1, finger_targets_gains, 2.0f, 0.01f, finger_kp, finger_kd);
  ...
  revo3_move_finger_with_joint_gains(ctx.handle, ctx.slave_id, 1, zero_finger, 2.0f, 0.01f, finger_kp, finger_kd);
